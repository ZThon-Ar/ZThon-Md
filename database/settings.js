...
module.exports = {
  ...
  WELCOME_MSG: req.MESSAGE_MEM.WELCOME_MSG  === "" ? "مرحبـاً بك عــزيـزي, @user  في المجمــوعـة @gname" : req.MESSAGE_MEM.WELCOME_MSG,
  GOODBYE_MSG: req.MESSAGE_MEM.GOODBYE_MSG  === "" ? "الله وياك, @user  سـررنا بالتعـرف بـك .. بيباي" : req.MESSAGE_MEM.GOODBYE_MSG,
  AUTHOR: req.config.AUTHOR  === "" ? "ZThon-Ar" :  req.config.AUTHOR,
  ...
  OWNER_NAME: req.config.OWNER_NAME  === "" ? "ZThon-Ar" :  req.config.OWNER_NAME,
  ...
  ALIVE: req.MESSAGE_MEM.ALIVE  === "" ? "```البـوت يعمـل .. بنجـاح```" : req.MESSAGE_MEM.ALIVE,
  ...
  FOOTER:  req.config.FOOTER  === "" ?  "ZThon-Ar" : req.config.FOOTER,
