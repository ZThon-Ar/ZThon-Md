...
async function ZThonAr() {
  ...
  conn.ev.on("connection.update", async (s) => {
    ...
    if (connection === "close") {
      ...
      ZThonAr().catch((err) => console.log(err));
    } else {
      /*
       */
    }
...
app.listen(port, () => console.log(`ZThonAr Server listening on port http://localhost:${port}!`));
