...
module.exports = {
  ...
  //------------------------------------------------------------------------------------------------
  WELCOME_MSG: process.env.WELCOME_MSG                          || " مرحبـاً بك عــزيـزي, @user  في المجمــوعـة @gname",
  //------------------------------------------------------------------------------------------------
  GOODBYE_MSG: process.env.GOODBYE_MSG                          || " الله وياك, @user  سـررنا بالتعـرف بـك .. بيباي",
  //------------------------------------------------------------------------------------------------
  AUTHOR:  process.env.AUTHOR                                   || "ZThon-Ar" ,
  //------------------------------------------------------------------------------------------------
  OWNER_NAME:  process.env.OWNER_NAME                           || "ZThon-Ar",
  //------------------------------------------------------------------------------------------------
  ...
  //------------------------------------------------------------------------------------------------
  ALIVE: process.env.ALIVE                                      || "```البـوت يعمـل .. بنجـاح```",
  //------------------------------------------------------------------------------------------------
  FOOTER:   process.env.FOOTER                                  ||  "ZThon-Ar",
  //------------------------------------------------------------------------------------------------
